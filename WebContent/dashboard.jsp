...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <!-- Bootstrap core CSS -->
    <link href="login/login_files/bootstrap.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="login/login_files/signin.css" rel="stylesheet">

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="login/login_files/ie-emulation-modes-warning.js"></script>
    ...
    <script type="text/javascript">
        ...
        {
            $.ajax({ headers:{Accept:'application/json'}, type:'GET', url: "http://localhost:8080/api/groups", 
