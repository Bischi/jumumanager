...
<meta name="description" content="">
<meta name="author" content="">
<script src="./res/group.js">
	
</script>
<!--Groupconfig-->
<script src="./res/member.js">
	
</script>
<!--Memberconfig-->
<script src="./res/termin.js">
	
</script>
<!--Terminconfig-->
<script src="./res/lists.js">
...
<body>
			...
			<div class="container">
				...
				<div id="navbar" class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						<li class="active"><a href="./dashboarda.jsp">Home</a></li>
	...
	<div class="container editMemberContainer" style="display: none">
		...
		<table class="table table-hover" id="editMemberConfigData">
			<tr>
				<td><label for="fnameInput">Vorname</label><input type="text"
					class="form-control" placeholder="Vorname" id="fnameInput" /></td>
				<td><label for="lnameInput">Nachname</label><input type="text"
					class="form-control" placeholder="Nachname" id="lnameInput" /></td>
			</tr>
			<tr>
				<td><label for="emailInput">Email</label><input type="email"
					class="form-control" placeholder="Email" id="emailInput" /></td>
				<td><label for="passwdInput">Passwort</label><input
					type="password" class="form-control" placeholder="Password"
					id="passwdInput" /></td>
			</tr>
			<tr>
				<td><label for="instrumentSelect">Instrument</label><select
					id="instrumentSelect" class="form-control"></select></td>
				<td><label for="groupSelect">Gruppe</label><select
					id="groupSelect" class="form-control"></select></td>
			</tr>
			<tr>
				<td><label for="rightSelect">Rechte</label><select
					id="rightSelect" class="form-control"></select></td>
			</tr>

		</table>
		<button type="submit" class="btn btn-default" id="saveMemberButton"
			style="font-size: 17px;">
			<img data-holder-rendered="true" src="./img/personadd.svg"
				style="width: 24px; height: 24px;" data-src="holder.js/140x140"
				class="img-rounded" alt="30x30">Save
		</button>
		<button type="submit" class="btn btn-default" id="updateMemberButton"
			style="font-size: 17px;">
			<img data-holder-rendered="true" src="./img/personadd.svg"
				style="width: 24px; height: 24px;" data-src="holder.js/140x140"
				class="img-rounded" alt="30x30">Save
	...
	<div class="container addGroupContainer" style="display: none">
		...
		<table class="table table-hover" id="editGroupConfigData">
			<tr>
				<td><label for="nameInput">Gruppenname</label><input
					type="text" class="form-control" placeholder="Gruppenname"
					id="nameInput" /></td>
			</tr>
		</table>
		<button type="submit" class="btn btn-default" id="saveGroupButton"
			style="font-size: 17px;">
			<img data-holder-rendered="true" src="./img/personadd.svg"
				style="width: 24px; height: 24px;" data-src="holder.js/140x140"
				class="img-rounded" alt="30x30">
		</button>
	</div>
	...
	<div class="container editTerminContainer" style="display: none">
		...
		<table class="table table-hover" id="editTerminConfigData">
			<tr>
				<td><label for="nameInput">Bezeichnung</label><input
					type="text" class="form-control" placeholder="Bezeichnung"
					id="TerminNameInput" /></td>
				<td><label for="dateInput">Datum</label><input type="date"
					class="form-control" placeholder="12.12.2012" id="dateInput" /></td>
			</tr>
			<tr>
				<td><label for="starttimeInput">Startzeit</label><input
					type="time" class="form-control" placeholder="12:12"
					id="starttimeInput" /></td>
				<td><label for="endtimeInput">Endzeit</label><input type="time"
					class="form-control" placeholder="13:13" id="endtimeInput" /></td>
			</tr>
			<tr>
				<td><label for="typSelect">Typ</label><select id="typSelect"
					class="form-control"></select></td>
			</tr>

		</table>
		<button type="submit" class="btn btn-default" id="saveTerminButton"
			style="font-size: 17px;">
			<img data-holder-rendered="true" src="./img/personadd.svg"
				style="width: 24px; height: 24px;" data-src="holder.js/140x140"
				class="img-rounded" alt="30x30">Save
		</button>
		<button type="submit" class="btn btn-default" id="updateTerminButton"
			style="font-size: 17px;">
			<img data-holder-rendered="true" src="./img/personadd.svg"
				style="width: 24px; height: 24px;" data-src="holder.js/140x140"
				class="img-rounded" alt="30x30">Save
	...
	<div class="container MemberContainer" style="display: none">
		...
		<div class="page-header">
			...
			<button type="submit" class="btn btn-primary" id="addMemberButton"
				...
				<img data-holder-rendered="true" src="./img/personadd.svg"
					style="width: 24px; height: 24px;" data-src="holder.js/140x140"
					class="img-rounded" alt="50x30"> neuer User
			</button>
		</div>
	...
	<div class="container TerminContainer" style="display: none">
		...
		<div class="page-header">
			...
			<button type="submit" class="btn btn-primary" id="addTerminButton"
				style="font-size: 17px;">
				<img data-holder-rendered="true" src="./img/personadd.svg"
					style="width: 24px; height: 24px;" data-src="holder.js/140x140"
					class="img-rounded" alt="50x30"> neuer Termin
			</button>
		</div>
